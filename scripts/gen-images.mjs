...
const svg = (glyph, a, b) => `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
  ...
  <text x="400" y="560" font-size="26" text-anchor="middle" fill="hsl(${b}, 40%, 35%)" opacity="0.55" font-family="sans-serif">صامل</text>
</svg>`;
...
writeFileSync(
  ...
  banner(1, "#ea580c", "#b91c1c", "مزادات صامل المباشرة", "زايد الآن واربح أفضل الصفقات — بخصوصية وأمان تام", ["🔨", "🏆"])
);
writeFileSync(
...
writeFileSync(
  ...
  banner(3, "#c2410c", "#f97316", "موسم السيارات في صامل", "آلاف السيارات الجديدة والمستعملة بأفضل الأسعار", ["🚗", "🔑"])
);
