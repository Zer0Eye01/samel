  ...
  return (
    <div className="card p-4 space-y-3">
      ...
      <div className="flex items-center gap-3">
        <Avatar name={seller.name} color={seller.avatarColor} src={seller.avatarUrl} className="size-12 text-lg" />
        <div className="min-w-0">
          ...
          >
            {seller.name}
            {seller.isPro && (
              <span className="badge bg-neutral-900 text-primary-400">PRO</span>
            )}
          </Link>
