...
export async function AuctionCard({
  ...
  return (
    <Link
      ...
      className={cn(
        "card group overflow-hidden transition-all duration-200 hover:shadow-card-hover hover:-translate-y-0.5",
        className
      )}
    >
      ...
      <div className="p-3 space-y-1.5">
        <div className="flex items-baseline justify-between gap-2">
          <p className="text-neutral-900 font-bold font-display text-lg leading-tight">
